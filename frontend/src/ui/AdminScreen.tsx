...
export function AdminScreen() {
  ...
  return (
    <div className="max-w-7xl mx-auto space-y-6">
        ...
        <div className="flex items-center gap-4">
          ...
          <div>
            ...
            <p className="text-blue-100 text-sm mt-1">
              Configure system settings, KPI weights, and Monday.com integration
            </p>
          </div>
        </div>
      </div>
      ...
      <div className="bg-gradient-to-br from-white to-green-50 dark:from-gray-800 dark:to-gray-900 rounded-xl shadow-lg border border-gray-200 dark:border-gray-700 p-6">
        <div className="flex items-center justify-between mb-4">
          <div className="flex items-center gap-3">
          ...
          <div className="flex items-center gap-3">
            <div className="text-sm font-medium text-gray-600 dark:text-gray-400">
              Progress: <span className="font-bold text-gray-900 dark:text-white">{configProgress}%</span>
            </div>
            <div className="w-32 bg-gray-200 dark:bg-gray-700 rounded-full h-3 shadow-inner">
              <div
      ...
      <div className="bg-gradient-to-br from-white to-purple-50 dark:from-gray-800 dark:to-gray-900 rounded-xl shadow-lg border border-gray-200 dark:border-gray-700 p-6">
